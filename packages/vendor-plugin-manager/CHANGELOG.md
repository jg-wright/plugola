...
* The following workspace dependencies were updated
  * devDependencies
    * @plugola/plugin-manager bumped from 8.0.4 to 9.0.0
  * peerDependencies
    * @plugola/plugin-manager bumped from ^8.0.4 to ^9.0.0
...
* The following workspace dependencies were updated
  * devDependencies
    * @plugola/plugin-manager bumped from 8.0.0 to 8.0.2
  * peerDependencies
    * @plugola/plugin-manager bumped from ^8.0.0 to ^8.0.2
...
- The following workspace dependencies were updated
  - devDependencies
    - @plugola/plugin-manager bumped from 8.0.1 to 8.0.2
  - peerDependencies
    - @plugola/plugin-manager bumped from ^8.0.1 to ^8.0.2

## [4.0.2](https://github.com/jg-wright/plugola/compare/vendor-plugin-manager-v4.0.1...vendor-plugin-manager-v4.0.2) (2026-03-23)
...
## [4.0.1](https://github.com/jg-wright/plugola/compare/vendor-plugin-manager-v4.0.0...vendor-plugin-manager-v4.0.1) (2025-10-03)
